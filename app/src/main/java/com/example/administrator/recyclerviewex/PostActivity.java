package com.example.administrator.recyclerviewex;
...
public class PostActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        */
        ...
        item_list.add(new PostItems(R.drawable.imageex2));
        item_list.add(new PostItems(R.drawable.imageex3));
        item_list.add(new PostItems(R.drawable.imageex4));
        item_list.add(new PostItems(R.drawable.imageex5,"이미지 예제 5"));
